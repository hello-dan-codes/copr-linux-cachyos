...
%define _module_args KERNEL_UNAME=%{_kver} IGNORE_PREEMPT_RT_PRESENCE=1 SYSSRC=%{_builddir}/linux-%{_gittag} SYSOUT=%{_builddir}/linux-%{_gittag}
...
Version:        %{_gittag}-%{_customver}
Release:        cachyos1-dj-%{?_lto_args:.lto}%{?dist}
